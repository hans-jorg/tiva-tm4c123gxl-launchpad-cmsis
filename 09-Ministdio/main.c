/**
 * @file     main.c
 * @brief    Uses a minimal set of stdio routines for serial i/o
 * @version  V1.0
 * @date     23/01/2016
 *
 * @note     A minimal stdio is implemented
...
/**
 * @brief getchar and putchar defined using UART_SendChar e UART_ReceiveChar
 */
 //@{
